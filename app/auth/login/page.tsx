          ...
          <div className="absolute inset-0 flex items-center justify-center p-12">
            <div className="text-center text-white">
              ...
              <p className="mt-4 text-lg text-indigo-100">
                Join thousands of users who have found their calling through our comprehensive assessment tools.
              </p>
              <div className="mt-8 grid grid-cols-2 gap-6 text-left">
                <div className="rounded-lg bg-white/10 p-6 backdrop-blur-sm">
                  <div className="text-3xl font-bold">10K+</div>
                  <div className="mt-1 text-sm text-indigo-100">Active Users</div>
                </div>
                <div className="rounded-lg bg-white/10 p-6 backdrop-blur-sm">
                  <div className="text-3xl font-bold">500+</div>
                  <div className="mt-1 text-sm text-indigo-100">Career Paths</div>
                </div>
                <div className="rounded-lg bg-white/10 p-6 backdrop-blur-sm">
                  <div className="text-3xl font-bold">95%</div>
                  <div className="mt-1 text-sm text-indigo-100">Success Rate</div>
                </div>
                <div className="rounded-lg bg-white/10 p-6 backdrop-blur-sm">
                  <div className="text-3xl font-bold">24/7</div>
                  <div className="mt-1 text-sm text-indigo-100">Support</div>
                </div>
              </div>
            </div>
          </div>
